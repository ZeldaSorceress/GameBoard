...
function skyloft() {
    var audio = document.getElementById('sky');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
  ...
  function groose() {
    var audio = document.getElementById('groose');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
  ...
  function fitheme() {
    var audio = document.getElementById('fi');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
  ...
  function dungeon() {
    var audio = document.getElementById('dungeon');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
  ...
  function healing() {
    var audio = document.getElementById('healing');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
  ...
  function clocktown() {
    var audio = document.getElementById('clock');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
  ...
  function stormsong() {
    var audio = document.getElementById('storm');
    if (audio.paused) {
        audio.play();
        $('#play').removeClass('glyphicon-play-circle')
        $('#play').addClass('glyphicon-pause')
